...
This folder collects the longer-form research notes that support the main
repository story.
...
2. Read [Methodology](methodology.md) to understand the thermal model and solver choice.
