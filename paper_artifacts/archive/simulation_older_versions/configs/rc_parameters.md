...
```python
# MathExprPowerModel in gem5_fs_thermal.py
...
| Phase | --stats-period | Rationale |
|---|---|---|
| Phase 5 (bug discovery) | 0.0002 s (0.2 ms) | Capture first thermal step anomaly |
| Phase 5.5 (validation) | 0.0002 s | Consistency with Phase 5 for comparison |
| Phase 6 (EAS) | 0.005 s (5 ms) | EAS decisions at ~4ms; 25× smaller file |
